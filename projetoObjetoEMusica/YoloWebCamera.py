        ...
        for result in output_from_network:
            for detected_objects in result:
                ...
                if confidence_current > probability_minimum:
                    ...
                    # Defina a frequência (em Hertz) que você deseja para o "beep"
                    freq = 800  # Por exemplo, 1000 Hz

                    # Defina a duração (em milissegundos) que você deseja para o "beep"
                    duracao = 3000  # 3 segundos

                    # Tocar o "beep" contínuo
